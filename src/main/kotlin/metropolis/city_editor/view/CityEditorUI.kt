package metropolis.city_editor.view
...
import metropolis.city_editor.controller.Id
...
private fun Header(state: EditorState<City>) {
    ...
    val countyCode : Attribute<String>        = state[Id.COUNTRY_CODE]
    ...
    Row(modifier = Modifier.height(IntrinsicSize.Max).padding(10.dp)){
        Column(modifier = Modifier.weight(1.0f)) {
            ...
            VSpace(10.dp)
            Headline(text = countyCode.value.format("??"), fontSize = large)
        }
    }
}
