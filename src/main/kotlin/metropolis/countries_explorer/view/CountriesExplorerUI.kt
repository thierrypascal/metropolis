...
@Composable
fun ApplicationScope.CountriesExplorerWindow(state       : TableState<Country>,
    ...
    Window(title          = state.title,
        ...
        CountriesExplorerUI(state, dataProvider, idProvider, trigger)
    }
}

@Composable
fun CountriesExplorerUI(state       : TableState<Country>,
                        dataProvider: (Int) -> Country,
                        idProvider  : (Country) -> Int,
                        trigger     : (LazyTableAction) -> Unit) {
